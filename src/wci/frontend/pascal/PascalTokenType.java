...
public enum PascalTokenType implements TokenType
{
    ...
    FILE, FOR, FUNCTION, GOTO, GREATERTHAN0, IF, IN, LABEL, LESSTHAN0,
    LOOP, MOD, NIL, NOT, OF, OR, PACKED, PROCEDURE, PROGRAM, RECORD,
    REPEAT, SET, THEN, TO, TYPE, UNTIL, VAR, WHEN, WHILE, WITH,
